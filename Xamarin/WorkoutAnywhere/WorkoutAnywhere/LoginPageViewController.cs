...
namespace WorkoutAnywhere
{
	partial class LoginPageViewController : UIViewController
	{
		...
		{
			SignUpController signUpController = this.Storyboard.InstantiateViewController("SignUpController") as SignUpController;
			this.NavigationController.PushViewController (signUpController, true);
		}
